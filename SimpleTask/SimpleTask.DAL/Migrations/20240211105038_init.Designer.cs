...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleTask.DAL.Domains.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SimpleTask.DAL.Domains.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SimpleTask.DAL.Domains.Document", b =>
                {
                    ...
                    b.HasOne("SimpleTask.DAL.Domains.ApplicationUser", "applicationUser")
                        .WithMany("documents")
